...
com.nature.Truncator = (function ($) {
	...
	var getContextSnippet = function ($haystack, $needle, leadingchars, trailingchars) {
		...
		if (typeof leadingchars === 'undefined') {
			leadingchars = null;
		} 
		if (typeof trailingchars === 'undefined') {
			trailingchars = null;
		} 
		...
		var leading = getLeading(haystack, pos, leadingchars);
		var trailing = getTrailing(haystack, pos + needle.length + 5, trailingchars);
